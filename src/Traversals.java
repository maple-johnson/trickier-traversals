...
public class Traversals {
  ...
  public static int sumLeafNodes(TreeNode<Integer> node) 
  {
    ...
    if (node.left == null && node.right == null) return left + right + node.value;
  ...
  public static int countInternalNodes(TreeNode<Integer> node) 
  {
    ...
    if (node.left != null || node.right != null) return left + right + 1;
    else return left + right;
  }
  ...
  public static boolean hasStrictlyIncreasingPathHelper(TreeNode<Integer> node)
  {
    boolean left = false;
    boolean right = false;
    ...
    if (node.left != null)
    {
      ...
      {
        left = hasStrictlyIncreasingPath(node.left);
        return true;
      }
    ...
    if (node.right != null)
    {
      ...
      {
        right = hasStrictlyIncreasingPath(node.right);
        return true;
      }
